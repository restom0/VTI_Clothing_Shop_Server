    ...
    private GrpcWriteCommandResponse handleOrderCommand(GrpcWriteCommandRequest request) throws Exception {
        ...
        return switch (action) {
            case "ADD_CART", "CREATE_CART" -> {
                ...
                OrderDTO order = orderService.addOrder(orderCreateRequest, request.getActorId());
            ...
            case "UPDATE" -> {
                ...
                OrderUpdateRequest updateRequest = objectMapper.treeToValue(payload.required("request"), OrderUpdateRequest.class);
